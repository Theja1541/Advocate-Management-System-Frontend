...
export const PMODS = ['Cases', 'Case Approval', 'Case Diary', 'Documents', 'Land Details', 'Legal Opinions', 'Advocates', 'Clients', 'Membership', 'Day Book', 'Payments', 'Reports', 'Bare Acts', 'Settings'];
export const PERMS = {
